...
{
    using Microsoft.Diagnostics.Tracing.Parsers.MicrosoftSystemNetHttpListener;

    [System.CodeDom.Compiler.GeneratedCode("traceparsergen", "2.0")]
    public sealed class MicrosoftSystemNetHttpListenerTraceEventParser : TraceEventParser 
    {
        public static string ProviderName = "Microsoft-System-Net-HttpListener";
        public static Guid ProviderGuid = new Guid(unchecked((int) 0x9f752523), unchecked((short) 0xab58), unchecked((short) 0x5706), 0x15, 0xd3, 0x81, 0x29, 0xd2, 0x6a, 0x84, 0x0c);
        ...
        public MicrosoftSystemNetHttpListenerTraceEventParser(TraceEventSource source) : base(source) {}
        ...
        protected override void EnumerateTemplates(Func<string, string, EventFilterResponse> eventsToObserve, Action<TraceEvent> callback)
        {
            if (s_templates == null)
            {
                ...
                templates[6] = DumpBufferTemplate(null);
                templates[7] = AssociateTemplate(null);
                templates[8] = EnumerateSecurityPackagesTemplate(null);
                templates[9] = SspiPackageNotFoundTemplate(null);
                templates[10] = AcquireDefaultCredentialTemplate(null);
                templates[11] = AcquireCredentialsHandleTemplate(null);
                templates[12] = InitializeSecurityContextTemplate(null);
                templates[13] = AcceptSecurityContextTemplate(null);
                templates[14] = OperationReturnedSomethingTemplate(null);
                templates[15] = SecurityContextInputBuffersTemplate(null);
...
namespace Microsoft.Diagnostics.Tracing.Parsers.MicrosoftSystemNetHttpListener
{
    public sealed class AcceptSecurityContextArgs : TraceEvent
    {
        ...
        public static string GetProviderName() { return "Microsoft-System-Net-HttpListener"; }
        public static Guid GetProviderGuid() { return new Guid("9f752523-ab58-5706-15d3-8129d26a840c"); }
